...
{
    public class ILSearchViewModel : SearchViewModel
    {
        ILObservableCollection<Recipe> ILSearchResults;

        public ILSearchViewModel(IDataService dataService, INavigationService navigationService, IPageLocator pageLocator)
        ...
        {
            return await _dataService.SearchRecipesAsync(SearchQuery, count);
        }
    }
}
